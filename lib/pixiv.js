...
(function() {
  var API_URL_BASE, LOGIN_PAGE_URL, Promise, Session, Work, makeQuery, pixiv, request;

  API_URL_BASE = "http://spapi.pixiv.net/iphone" || process.env.PIXIV_API_URL_BASE;

  LOGIN_PAGE_URL = "https://www.secure.pixiv.net/login.php" || process.env.PIXIV_LOGIN_PAGE_URL;
